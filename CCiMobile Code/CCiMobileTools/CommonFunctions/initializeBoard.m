function boardHandle = initializeBoard

    p = min(FindCCiMobileComPorts);
    if isempty(p)
        error('Unable to find CCiMobile')
    end
    ...
    boardHandle = class_interface(p,5000000);  % 8 is the COM port on my machine - Update this to match the COM port of the interface card on your machine
