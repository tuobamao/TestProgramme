classdef ACE < Strategy
    ...
    methods (Access = public)
        ...
        function [out_l,out_r] = process(obj,in_l,in_r)
            out_l = []; out_r = [];
            if ~isempty(in_l)
                [out_l,obj.z_l,obj.bufhistory_l] = obj.run_ace(in_l,obj.lmap, ...
                    obj.lparams,obj.bufhistory_l,obj.z_l);
            end
            if ~isempty(in_r)
                [out_r,obj.z_r,obj.bufhistory_r] = obj.run_ace(in_r,obj.rmap, ...
    ...
    methods (Access = private)
        function [out,z,bufhistory] = run_ace(obj,in,map,params,bufhistory,z)
